...
class MonSiteWeb(object):
   ...
   # Connexion à la base de données
    ...
    def index(self):
        ...
        <body>
            <div class="container">
                ...
                <p>
                    Cliquez sur le boutton pour commencer le questionnaire.
                </p>
    ...
    def questionnaire(self):
        ...
        Avez-vous déjà participez à une campagne de sensibilisation sur la santé sexuelle et reproductive ?
        ...
        Combien de partenaires sexuels avez-vous eu au cours de votre vie ? :
        ...
        Avez-vous déjà été testé pour les infections sexuellement transmissibles (ist) ?
        <input type="radio" id="oui" name="ist" value="Oui" required>
        <label for="oui">Oui</label>
        <input type="radio" id="non" name="ist" value="Non" required>
        <label for="non">Non</label><br><br> 
            
        Le préservatif est-il efficace pour prévenir les grossesses et les ist ?
        ...
        Quelles sont les différentes maladies sexuellement transmissibles (mst) que vous connaissez ?
             <select name="mst" required>
                <option value="Aucune">Aucune</option>
        ...
        Comment amélioreriez-vous l'accès à l'éducation sexuelle et aux services de santé reproductive pour les jeunes ?
    ...
    def submit(self,age, sexe, sensibilisation,dernier_rapport,contraception,mst, amelioration, ist, preservatif, partenaires):
        ...
        cursor = conn.cursor()
        cursor.execute("INSERT INTO reponses (age, sexe, sensibilisation,dernier_rapport,contraception,mst, amelioration, ist, preservatif, partenaires) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",
                       (age, sexe, sensibilisation,dernier_rapport,contraception,mst, amelioration, ist, preservatif, partenaires))
        conn.commit()
        conn.close()
